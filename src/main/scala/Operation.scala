...
/**
  * Case class that handles purchasing operations
  */ 
case class Purchase(name: String,
                    currency: String,
                    count: Int,
                    price: Double) extends QueuedOperation

/**
  * Case class that handles selling operations
  */ 
case class Selling(name: String,
                   currency: String,
                   count: Int,
                   price: Double) extends QueuedOperation
